...
import 'package:landing_page_portfolio/controller/cubits/cubit_export.dart';
import 'package:landing_page_portfolio/view/navigator/navigator_screen.dart';
...
class WorkLocation extends BeamLocation<BeamState> {
  ...
  List<BeamPage> buildPages(BuildContext context, BeamState state) {
    ...
    if (state.pathParameters.containsKey('workId')) {
      ...
      context.read<WorkOnlyCubit>().getOnlyWork(workId!);
      context.read<ProcessCubit>().getAllProcess(workId);
